...
export const STARTERS: Starter[] = [
  ...
  },
  {
    ...
    bg: "#3A1A0E",
    els: [
      { t: "rect", x: 0.78, y: 0.5, w: 0.5, h: 1.2, fill: "#D85A30" },
      { t: "logo", x: 0.2, y: 0.42, w: 0.1 },
      { t: "text", x: 0.2, y: 0.62, w: 0.5, text: "SC Pronto", size: 0.055, font: "Playfair Display", fill: "#FBF4E8", align: "left", bold: true },
      { t: "text", x: 0.2, y: 0.74, w: 0.5, text: "Specialty coffee, made fast", size: 0.026, font: "Montserrat", fill: "#C9A06A", align: "left" },
    ],
  },
  {
    key: "fbpromo",
    ...
    bg: "#FBF4E8",
    els: [
      { t: "rect", x: 0.27, y: 0.5, w: 0.54, h: 1.3, fill: "#3A1A0E" },
      { t: "logo", x: 0.27, y: 0.34, w: 0.14 },
      { t: "text", x: 0.27, y: 0.56, w: 0.46, text: "Buy one,\nget one free", size: 0.066, font: "Playfair Display", fill: "#FBF4E8", align: "center", bold: true },
      { t: "text", x: 0.27, y: 0.72, w: 0.44, text: "Every Friday this month", size: 0.03, font: "Montserrat", fill: "#C9A06A", align: "center" },
      { t: "text", x: 0.74, y: 0.42, w: 0.42, text: "FRIDAY", size: 0.05, font: "Montserrat", fill: "#A8451F", align: "center", bold: true },
      { t: "text", x: 0.74, y: 0.55, w: 0.46, text: "BOGO", size: 0.16, font: "Bebas Neue", fill: "#D85A30", align: "center" },
      { t: "text", x: 0.74, y: 0.66, w: 0.42, text: "on all espresso drinks", size: 0.028, font: "Montserrat", fill: "#3A1A0E", align: "center" },
    ],
  },
];
