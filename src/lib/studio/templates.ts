...
export const STARTERS: Starter[] = [
  ...
  },
  {
    ...
    bg: "#FBF4E8",
    els: [
      { t: "circle", x: 0.5, y: 0.22, r: 0.13, fill: "#D85A30" },
      { t: "text", x: 0.5, y: 0.22, w: 0.24, text: "WEEKEND", size: 0.038, font: "Bebas Neue", fill: "#FBF4E8", align: "center" },
      { t: "text", x: 0.5, y: 0.46, w: 0.85, text: "Special of\nthe week", size: 0.085, font: "Playfair Display", fill: "#3A1A0E", align: "center", bold: true },
      { t: "text", x: 0.5, y: 0.64, w: 0.8, text: "Fresh croissants & espresso — $6", size: 0.04, font: "Montserrat", fill: "#A8451F", align: "center" },
      { t: "logo", x: 0.5, y: 0.86, w: 0.13 },
    ],
  },
  {
    key: "hiring",
    ...
    bg: "#3A1A0E",
    els: [
      { t: "logo", x: 0.5, y: 0.14, w: 0.16 },
      { t: "text", x: 0.5, y: 0.4, w: 0.9, text: "WE'RE HIRING", size: 0.13, font: "Oswald", fill: "#E8743F", align: "center", bold: true },
      { t: "text", x: 0.5, y: 0.56, w: 0.8, text: "Join the SC Pronto team", size: 0.05, font: "Montserrat", fill: "#FBF4E8", align: "center" },
      { t: "rect", x: 0.5, y: 0.72, w: 0.5, h: 0.09, fill: "#D85A30", rx: 14 },
      { t: "text", x: 0.5, y: 0.72, w: 0.48, text: "Apply today", size: 0.04, font: "Montserrat", fill: "#FBF4E8", align: "center", bold: true },
    ],
  },
  {
    key: "thanks",
    ...
    bg: "#FBF4E8",
    els: [
      { t: "text", x: 0.5, y: 0.44, w: 0.85, text: "Thank you", size: 0.12, font: "Pacifico", fill: "#D85A30", align: "center" },
      { t: "text", x: 0.5, y: 0.6, w: 0.8, text: "For being part of our story", size: 0.04, font: "Montserrat", fill: "#3A1A0E", align: "center" },
      { t: "logo", x: 0.5, y: 0.82, w: 0.14 },
    ],
  },
  {
    key: "menu",
    ...
    bg: "#3A1A0E",
    els: [
      { t: "logo", x: 0.5, y: 0.1, w: 0.16 },
      { t: "text", x: 0.5, y: 0.22, w: 0.8, text: "TODAY'S MENU", size: 0.075, font: "Bebas Neue", fill: "#FBF4E8", align: "center" },
      { t: "rect", x: 0.5, y: 0.29, w: 0.3, h: 0.005, fill: "#D85A30" },
      { t: "text", x: 0.5, y: 0.42, w: 0.8, text: "Espresso — $3", size: 0.045, font: "Montserrat", fill: "#FBF4E8", align: "center" },
      { t: "text", x: 0.5, y: 0.52, w: 0.8, text: "Cappuccino — $4.5", size: 0.045, font: "Montserrat", fill: "#FBF4E8", align: "center" },
      { t: "text", x: 0.5, y: 0.62, w: 0.8, text: "Croissant — $3.5", size: 0.045, font: "Montserrat", fill: "#FBF4E8", align: "center" },
      { t: "text", x: 0.5, y: 0.72, w: 0.8, text: "Avocado Toast — $7", size: 0.045, font: "Montserrat", fill: "#FBF4E8", align: "center" },
    ],
  },
];
